function varargout = Allen_PG_Drive(varargin)
% ALLEN_PG_DRIVE MATLAB code for Allen_PG_Drive.fig
%      ALLEN_PG_DRIVE, by itself, creates a new ALLEN_PG_DRIVE or raises the existing
%      singleton*.
%
%      H = ALLEN_PG_DRIVE returns the handle to a new ALLEN_PG_DRIVE or the handle to
%      the existing singleton*.
%
%      ALLEN_PG_DRIVE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ALLEN_PG_DRIVE.M with the given input arguments.
%
%      ALLEN_PG_DRIVE('Property','Value',...) creates a new ALLEN_PG_DRIVE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Allen_PG_Drive_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Allen_PG_Drive_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Allen_PG_Drive

% Last Modified by GUIDE v2.5 21-Apr-2022 12:17:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Allen_PG_Drive_OpeningFcn, ...
                   'gui_OutputFcn',  @Allen_PG_Drive_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Allen_PG_Drive is made visible.
function Allen_PG_Drive_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Allen_PG_Drive (see VARARGIN)

% Choose default command line output for Allen_PG_Drive
...
% UIWAIT makes Allen_PG_Drive wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Allen_PG_Drive_OutputFcn(hObject, eventdata, handles) 
